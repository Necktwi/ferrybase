...
${OBJECTDIR}/ClientSocket_nomain.o: ${OBJECTDIR}/ClientSocket.o ClientSocket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientSocket_nomain.o ClientSocket.cpp;\
	else  \
...
${OBJECTDIR}/FFJSON_nomain.o: ${OBJECTDIR}/FFJSON.o FFJSON.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FFJSON_nomain.o FFJSON.cpp;\
	else  \
...
${OBJECTDIR}/JPEGImage_nomain.o: ${OBJECTDIR}/JPEGImage.o JPEGImage.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JPEGImage_nomain.o JPEGImage.cpp;\
	else  \
...
${OBJECTDIR}/ServerSocket_nomain.o: ${OBJECTDIR}/ServerSocket.o ServerSocket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServerSocket_nomain.o ServerSocket.cpp;\
	else  \
...
${OBJECTDIR}/Socket_nomain.o: ${OBJECTDIR}/Socket.o Socket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Socket_nomain.o Socket.cpp;\
	else  \
...
${OBJECTDIR}/logger_nomain.o: ${OBJECTDIR}/logger.o logger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/logger_nomain.o logger.cpp;\
	else  \
...
${OBJECTDIR}/myconverters_nomain.o: ${OBJECTDIR}/myconverters.o myconverters.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myconverters_nomain.o myconverters.cpp;\
	else  \
...
${OBJECTDIR}/mycurl_nomain.o: ${OBJECTDIR}/mycurl.o mycurl.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mycurl_nomain.o mycurl.cpp;\
	else  \
...
${OBJECTDIR}/mystdlib_nomain.o: ${OBJECTDIR}/mystdlib.o mystdlib.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mystdlib_nomain.o mystdlib.cpp;\
	else  \
...
${OBJECTDIR}/myxml_nomain.o: ${OBJECTDIR}/myxml.o myxml.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -D_DEBUG -I/usr/include/libxml2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myxml_nomain.o myxml.cpp;\
	else  \
